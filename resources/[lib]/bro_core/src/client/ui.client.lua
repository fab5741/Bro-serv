...
function TextNotification(settings)
	...
	settings = settings or {}
	local text = settings.text or "Text"
	local time = settings.time or 3000
...
RegisterNetEvent('bro_core:AdvancedNotification')
AddEventHandler('bro_core:AdvancedNotification', AdvancedNotification)

RegisterNetEvent('bro_core:TextNotification')
AddEventHandler('bro_core:TextNotification', TextNotification)
