...
RegisterCommand('car', function(source, args)
    exports.bro_core:spawnCar(args[1] or 'adder', args[2] or true, nil, args[3] or true)
end, false)


-- tp
RegisterCommand("tpm", function(source)
    exports.bro_core:tpPlayer(PlayerPedId(), true)
end)
...
RegisterCommand("tp", function(source, args)
    ...
    exports.bro_core:tpPlayer(PlayerPedId(), false, pos)
end)
...
RegisterCommand("revive", function(source)
    TriggerEvent('lsms:revive', GetPlayerPed(-1))
end)
...
RegisterCommand("admin", function(source, args) 
    ...
    exports.bro_core:tpPlayer(PlayerPedId(), false, pos, true)
end)
