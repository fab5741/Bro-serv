...
function load_armory()
	...
	buttonsCategories[#buttonsCategories+1] = {name = "armory_basic_kit", func = "giveBasicKit", params = ""}
	if config.enableOutfits then
		buttonsCategories[#buttonsCategories+1] = {name = "armory_add_bulletproof_vest_title", func = "addBulletproofVest", params = ""}
		buttonsCategories[#buttonsCategories+1] = {name = "armory_remove_bulletproof_vest_title", func = "removeBulletproofVest", params = ""}
	end
	buttonsCategories[#buttonsCategories+1] = {name = "armory_weapons_list", func = "openWeaponListMenu", params = ""}
...
function openWeaponListMenu()
	CloseMenu()
	SendNUIMessage({
		title = "armory_global_title",
		subtitle = "armory_weapons_list",
