  ...
  Citizen.CreateThread(function()
    ...
    if not Player.all[source] then
      ...
      if identifier == nil then
        ...
        emit('BF:player:load:error', source, name)
        emitClient('BF:player:load:error', source)
        ...
        Player.ensure({
          ...
          emit('BF:player:load', player)
          emitClient('BF:player:load', source, source)
