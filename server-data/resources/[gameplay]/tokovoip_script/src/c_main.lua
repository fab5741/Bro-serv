...
Citizen.CreateThread(function()
		Wait(20000)
		TriggerEvent("TokoVoip:addPlayerToRadio", 1, "lspd")
		TriggerEvent("TokoVoip:addPlayerToRadio", 2, "lspd")
		TriggerEvent("TokoVoip:addPlayerToRadio", 3, "lspd")
		TriggerEvent("TokoVoip:addPlayerToRadio", 4B, "lspd")
end)